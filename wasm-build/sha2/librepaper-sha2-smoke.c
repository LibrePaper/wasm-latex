...
int main(void)
{
    ...
    librepaper_sha256("abc", 3, digest);
    if (!check(digest, 32,
               "ba7816bf8f01cfea414140de5dae2223"
               "b00361a396177a9cb410ff61f20015ad")) {
        return 1;
    }
    librepaper_sha384("abc", 3, digest);
    if (!check(digest, 48,
    ...
    librepaper_sha512("abc", 3, digest);
    if (!check(digest, 64,
    ...
    librepaper_sha256(sha256_long, strlen(sha256_long), digest);
    if (!check(digest, 32,
               "248d6a61d20638b8e5c026930c3e6039"
               "a33ce45964ff2167f6ecedd419db06c1")) {
        return 4;
    }
    librepaper_sha384(sha512_long, strlen(sha512_long), digest);
    if (!check(digest, 48,
    ...
    librepaper_sha512(sha512_long, strlen(sha512_long), digest);
    if (!check(digest, 64,
    ...
    puts("LibrePaper SHA-2 smoke test passed");
    return 0;
}
