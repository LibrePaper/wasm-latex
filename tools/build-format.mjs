...
import { buildXetexFontList } from './xetex-fontlist.mjs'
...
// Live; it is generated at build time from every OpenType/TrueType font in the
...
if (engine === 'xetex') {
  extraFiles.set('26/xetexfontlist.txt', Buffer.from(buildXetexFontList(texmfDirs, { log }), 'utf8'))
}
